...
def profile_api_call(section_name, client_method, output_file, **kwargs):
    ...
    logger.info(f"{section_name} - Response size: {result_size_mb:.4f} MB ({result_size_kb:.2f} KB)")
...
def main():
    ...
    parser.add_argument('--number_of_properties', type=int, default=DEFAULT_NUMBER_OF_PROPERTIES,
    ...
    parser.add_argument('--env', type=str, default=ENV,
                        help='Environment to use for the API calls')
    ...
    profile_api_call(
        ...
        output_file,
        parcl_property_ids=parcl_property_id_list[:100],
        event_type='SALE',
