...
class MarketMetricsHousingEventCounts(ParclLabsService):
    ...
    def retrieve(
        ...
        results =  self._request(
            url=f'/v1/market_metrics/{parcl_id}/housing_event_counts', 
            params=params
        )
...
class MarketMetricsHousingStock(ParclLabsService):
    ...
    def retrieve(
        ...
        results =  self._request(
            url=f'/v1/market_metrics/{parcl_id}/housing_stock', 
            params=params
        )
...
class MarketMetricsHousingEventPrices(ParclLabsService):
    ...
    def _as_pd_dataframe(
        ...
        for k, l in data.items():
            for v in l:
                ...
                price_median_new_rental_listings = v.get('price').get('median').get('new_rental_listings')
                price_standard_deviation_sales = v.get('price').get('standard_deviation').get('sales')
                price_standard_deviation_new_listings_for_sale = v.get('price').get('standard_deviation').get('new_listings_for_sale')
                price_standard_deviation_new_rental_listings = v.get('price').get('standard_deviation').get('new_rental_listings')
                price_percentile_20th_sales = v.get('price').get('percentile_20th').get('sales')
                price_percentile_20th_new_listings_for_sale = v.get('price').get('percentile_20th').get('new_listings_for_sale')
                price_percentile_20th_new_rental_listings = v.get('price').get('percentile_20th').get('new_rental_listings')
                price_percentile_80th_sales = v.get('price').get('percentile_80th').get('sales')
                price_percentile_80th_new_listings_for_sale = v.get('price').get('percentile_80th').get('new_listings_for_sale')
                price_percentile_80th_new_rental_listings = v.get('price').get('percentile_80th').get('new_rental_listings')
                price_per_square_foot_median_sales = v.get('price_per_square_foot').get('median').get('sales')
                price_per_square_foot_median_new_listings_for_sale = v.get('price_per_square_foot').get('median').get('new_listings_for_sale')
                price_per_square_foot_median_new_rental_listings = v.get('price_per_square_foot').get('median').get('new_rental_listings')
                price_per_square_foot_standard_deviation_sales = v.get('price_per_square_foot').get('standard_deviation').get('sales')
                price_per_square_foot_standard_deviation_new_listings_for_sale = v.get('price_per_square_foot').get('standard_deviation').get('new_listings_for_sale')
                price_per_square_foot_standard_deviation_new_rental_listings = v.get('price_per_square_foot').get('standard_deviation').get('new_rental_listings')
                price_per_square_foot_percentile_20th_sales = v.get('price_per_square_foot').get('percentile_20th').get('sales')
                price_per_square_foot_percentile_20th_new_listings_for_sale = v.get('price_per_square_foot').get('percentile_20th').get('new_listings_for_sale')
                price_per_square_foot_percentile_20th_new_rental_listings = v.get('price_per_square_foot').get('percentile_20th').get('new_rental_listings')
                price_per_square_foot_percentile_80th_sales = v.get('price_per_square_foot').get('percentile_80th').get('sales')
                price_per_square_foot_percentile_80th_new_listings_for_sale = v.get('price_per_square_foot').get('percentile_80th').get('new_listings_for_sale')
                price_per_square_foot_percentile_80th_new_rental_listings = v.get('price_per_square_foot').get('percentile_80th').get('new_rental_listings')
                tmp = pd.DataFrame({
                    'date': date,
    ...
    def retrieve(
        ...
        results =  self._request(
            url=f'/v1/market_metrics/{parcl_id}/housing_event_prices', 
            params=params
        )
