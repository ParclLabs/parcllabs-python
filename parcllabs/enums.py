...
class EventNames(Enum):
    ALL_SOLD = "ALL_SOLD"
    SOLD = "SOLD"
    NON_ARMS_LENGTH_TRANSFER = "NON_ARMS_LENGTH_TRANSFER"
    NON_ARMS_LENGTH_INTRA_PORTFOLIO_TRANSFER = (
        "NON_ARMS_LENGTH_INTRA_PORTFOLIO_TRANSFER"
    )
    SOLD_INTER_PORTFOLIO_TRANSFER = "SOLD_INTER_PORTFOLIO_TRANSFER"
    ...
    RENTAL_LISTING_REMOVED = "RENTAL_LISTING_REMOVED"
    RENTAL_PRICE_CHANGE = "RENTAL_PRICE_CHANGE"


class ValidOwnerNames(str, Enum):
    AMHERST = "AMHERST"
    VINEBROOK_HOMES = "VINEBROOK_HOMES"
    SFR3 = "SFR3"
    PROGRESS_RESIDENTIAL = "PROGRESS_RESIDENTIAL"
    FIRSTKEY_HOMES = "FIRSTKEY_HOMES"
    AMERICAN_HOMES_FOR_RENT = "AMERICAN_HOMES_FOR_RENT"
    TRICON = "TRICON"
    MAYMONT_HOMES = "MAYMONT_HOMES"
    INVITATION_HOMES = "INVITATION_HOMES"
    HOME_PARTNERS_OF_AMERICA = "HOME_PARTNERS_OF_AMERICA"
