...
def create_dual_axis_chart(
    ...
    if bar1_data is not None and bar1_series is not None:
        ...
        fig.add_trace(go.Bar(
            ...
            marker=dict(color=style_config['bar1_color'], opacity=style_config['bar1_opacity']),
            name=bar1_series,
            yaxis='y2'
        ))
    ...
    if bar2_data is not None and bar2_series is not None:
        ...
        fig.add_trace(go.Bar(
            ...
            marker=dict(color=style_config['bar2_color'], opacity=style_config['bar2_opacity']),
            name=bar2_series,
            yaxis='y2'
        ))
